...
-- Requires add-profile-depth-columns.sql to have been run first (prompts/subjects/interests/availability columns).
...
INSERT INTO profiles (
  ...
  (gen_random_uuid(), 'mia@seed.test',    'Mia Chen',       'University of Melbourne',           'Computer Science',           '2nd Year',  '2004-03-12', 'Morning',   'Solo',    'Focused',    20, 'She/Her',  'https://i.pravatar.cc/400?img=47', 'CS nerd, love ML. Coffee addict.',
  ...
  (gen_random_uuid(), 'liam@seed.test',   'Liam O''Brien',  'University of Sydney',              'Mechanical Engineering',     '3rd Year',  '2003-07-22', 'Evening',   'Group',   'Motivated',  21, 'He/Him',   'https://i.pravatar.cc/400?img=12', 'Gym, CAD, good vibes.',
  ...
  (gen_random_uuid(), 'aisha@seed.test',  'Aisha Patel',    'University of New South Wales',     'Medicine',                   '4th Year',  '2002-11-03', 'Night',     'Solo',    'Focused',    22, 'She/Her',  'https://i.pravatar.cc/400?img=32', 'Med student surviving on espresso.',
  ...
  (gen_random_uuid(), 'noah@seed.test',   'Noah Williams',  'Monash University',                 'Law',                        '2nd Year',  '2004-01-18', 'Afternoon', 'Hybrid',  'Chill',      20, 'He/Him',   'https://i.pravatar.cc/400?img=14', 'Law + philosophy, down to debate.',
  ...
  (gen_random_uuid(), 'zoe@seed.test',    'Zoe Nguyen',     'University of Queensland',          'Psychology',                 '1st Year',  '2005-05-09', 'Morning',   'Group',   'Motivated',  19, 'She/Her',  'https://i.pravatar.cc/400?img=45', 'First year psych, love study groups.',
  ...
  (gen_random_uuid(), 'ethan@seed.test',  'Ethan Ross',     'University of Adelaide',            'Physics',                    '3rd Year',  '2003-09-28', 'Night',     'Solo',    'Curious',    21, 'He/Him',   'https://i.pravatar.cc/400?img=33', 'Quantum mechanics or bust.',
  ...
  (gen_random_uuid(), 'priya@seed.test',  'Priya Sharma',   'Flinders University',               'Biomedical Science',         '2nd Year',  '2004-04-15', 'Afternoon', 'Library', 'Focused',    20, 'She/Her',  'https://i.pravatar.cc/400?img=48', 'Bio labs are life. Taylor Swift fan.',
  ...
  (gen_random_uuid(), 'jack@seed.test',   'Jack Thompson',  'RMIT University',                   'Architecture',               '3rd Year',  '2003-12-04', 'Evening',   'Hybrid',  'Chill',      21, 'He/Him',   'https://i.pravatar.cc/400?img=8',  'Sketch, build, repeat.',
  ...
  (gen_random_uuid(), 'olivia@seed.test', 'Olivia Tran',    'University of Technology Sydney',   'Graphic Design',             '1st Year',  '2005-02-26', 'Afternoon', 'Online',  'Curious',    19, 'She/Her',  'https://i.pravatar.cc/400?img=44', 'Figma wizard. Cat mom.',
  ...
  (gen_random_uuid(), 'lucas@seed.test',  'Lucas Hayes',    'Australian National University',    'Economics',                  '2nd Year',  '2004-06-17', 'Morning',   'Group',   'Motivated',  20, 'He/Him',   'https://i.pravatar.cc/400?img=11', 'Markets, running, coffee.',
  ...
  (gen_random_uuid(), 'harper@seed.test', 'Harper Lee',     'Macquarie University',              'Marketing',                  '3rd Year',  '2003-08-30', 'Flexible',  'Group',   'Social',     21, 'They/Them','https://i.pravatar.cc/400?img=26', 'Brand strategy + karaoke nights.',
  ...
  (gen_random_uuid(), 'finn@seed.test',   'Finn Kelly',     'University of Western Australia',   'Marine Biology',             '4th Year',  '2002-10-11', 'Morning',   'Hybrid',  'Focused',    22, 'He/Him',   'https://i.pravatar.cc/400?img=15', 'Ocean > land. Dive buddy wanted.',
  ...
  (gen_random_uuid(), 'ava@seed.test',    'Ava Richardson', 'Queensland University of Technology','Nursing',                   '2nd Year',  '2004-07-05', 'Night',     'Solo',    'Chill',      20, 'She/Her',  'https://i.pravatar.cc/400?img=20', 'Nursing placements + yoga.',
  ...
  (gen_random_uuid(), 'kai@seed.test',    'Kai Anderson',   'Griffith University',               'Game Development',           '1st Year',  '2005-01-14', 'Evening',   'Online',  'Curious',    19, 'They/Them','https://i.pravatar.cc/400?img=7',  'Making indie games. D&D Fridays.',
  ...
  (gen_random_uuid(), 'sienna@seed.test', 'Sienna Kowalski','Deakin University',                 'International Relations',    'Honours',   '2001-09-20', 'Afternoon', 'Library', 'Motivated',  23, 'She/Her',  'https://i.pravatar.cc/400?img=31', 'Thesis grind. Languages: EN, PL, FR.',
